...
import { BaseTextAreaField, Tooltip as CustomTooltip } from '../src/components';

type Story = StoryObj<typeof BaseTextAreaField>;
// More on how to set up stories at: https://storybook.js.org/docs/react/writing-stories/introduction
const meta: Meta<typeof BaseTextAreaField> = {
  title: 'Form/Fields/BaseTextAreaField',
...
export const CustomHint: Story = {
  args: {
    ...
    rows: 5,
    renderHint: () => (
      <em className="mt-2">Write something descripting, canvas is yours!</em>
    ),
  },
};
